 ...
 * 去除前后空格
 */
String.prototype.Trim = function(is_global = false) {
    if (is_global) {
        // 是否删除所有空格
...
String.prototype.isIdCard = function() {
    return /(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}$)/.test(this.Trim());
};
// 判断是否为url
